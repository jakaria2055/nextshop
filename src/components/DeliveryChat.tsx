    ...
    <div className="bg-white rounded-3xl shadow-lg border p-4 h-[430px] flex flex-col">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <motion.button
          whileTap={{ scale: 0.9 }}
          disabled={loading}
          className="px-3 py-1 text=xs flex items-center gap-1 bg-purple-100 text-purple-700 rounded-full shadow-sm border border-purple-200 cursor-pointer cursor-pointer"
