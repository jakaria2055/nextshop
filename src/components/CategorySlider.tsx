...
function CategorySlider() {
  const categories = [
    ...
    { id: 7, name: "Personal Care", icon: User, color: "bg-purple-100" },
    { id: 8, name: "Household Essentials", icon: Home, color: "bg-gray-100" },
    {
      id: 9,
    ...
    { id: 10, name: "Baby & Pet Care", icon: Baby, color: "bg-indigo-100" },
  ];
  ...
  return (
    <motion.div className="w-[90%] md:w-[80%] mx-auto mt-10 relative">
      <h2 className="text-2xl md:text-3xl font-bold text-blue-700 mb-6 text-center border-b-2 border-blue-200">
        🏪 Shop by Category
      </h2>
      ...
      {showRight && (
        <button
          className="absolute right-0 top-1/2 -translate-y-1/2 bg-white shadow-lg hover:bg-green-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
